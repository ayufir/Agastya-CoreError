  ...
  const PropertyDetails = ({
    ...
    const initialValues = {
      ...
      typeOfStructure: "RCC",
      typeOfRoof: "RCC Slab",
      noOfFloorsPermissible: "0",
      noOfFloorsActual: "0",
      noOfUnitFlatOnEachFloor: "0",
    ...
    useEffect(() => {
      ...
      if (merged) {
        ...
        form.setFieldsValue({
          ...
          typeOfStructure: safeVal("typeOfStructure", "RCC"),
          typeOfRoof: safeVal("typeOfRoof", "RCC Slab"),
          noOfFloorsPermissible: safeVal("noOfFloorsPermissible", "0"),
          noOfFloorsActual: safeVal("noOfFloorsActual", "0"),
          noOfUnitFlatOnEachFloor: safeVal("noOfUnitFlatOnEachFloor", "0"),
