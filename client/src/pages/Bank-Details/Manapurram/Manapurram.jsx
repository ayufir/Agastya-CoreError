        ...
        dispatch(fetchManappuramById(id))
            ...
            .then((data) => {
                const nextForm = {
                    ...
                    siteBoundaries: data.siteBoundaries || INIT.siteBoundaries,
                    accessibility: data.accessibility || INIT.accessibility,
                    municipalDetails: data.municipalDetails || INIT.municipalDetails,
                    technicalDetails: data.technicalDetails || INIT.technicalDetails,
                    valuationGLR: data.valuationGLR || INIT.valuationGLR,
                    valuationPMR: data.valuationPMR || INIT.valuationPMR,
                    summary: data.summary || INIT.summary,
